...
Write-Host "Running Spike test - REST..." -ForegroundColor Cyan
Write-Host "Target: $env:BASE_URL" -ForegroundColor Yellow
Write-Host "Dashboard: http://localhost:5665" -ForegroundColor Green
Write-Host "JSON summary: results\rest\04-spike-summary.json" -ForegroundColor Green
Write-Host "Screenshots folder: screenshots\rest" -ForegroundColor Green
Write-Host ""

k6 run `
  --summary-export="results\rest\04-spike-summary.json" `
