...
$env:BASE_URL="http://localhost:8110"

Write-Host "Running async/event-driven smoke test..." -ForegroundColor Cyan
Write-Host "Target: $env:BASE_URL" -ForegroundColor Yellow

k6 run `
  --summary-export="results\async\01-smoke-summary.json" `
