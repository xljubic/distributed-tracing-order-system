...
class OrderServiceTest {
    ...
    void shouldCreateOrder() {
        CreateOrderRequest request = new CreateOrderRequest(List.of(
                new CreateOrderItemRequest(1L, "Lenovo ThinkPad E16", 2, new BigDecimal("899.99")),
                new CreateOrderItemRequest(2L, "iPhone 15", 1, new BigDecimal("999.99"))));
    ...
    void shouldReturnOrderByIdWhenOrderExists() {
        ...
        Order order = new Order(OrderStatus.CREATED, new BigDecimal("899.99"), now, now);
        order.addItem(new OrderItem(1L, "Lenovo ThinkPad E16", 1, new BigDecimal("899.99"), new BigDecimal("899.99")));
        ...
        assertEquals("CREATED", result.status());
        assertEquals(new BigDecimal("899.99"), result.totalAmount());
