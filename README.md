...
Niswar uses exactly 100, 200, 300, 400, and 500 requests at one VU with a fixed 128-byte payload. Jarmoszewicz uses flat responses, exactly 1,024-byte and 896,000-byte payloads, 60-second arrival-rate profiles of 150, 300, and 100-to-1,200 requests per second for small data, and 60-second constant/ramping active-VU profiles of 50, 100, and 2-to-100 VUs for large data. Hamo uses flat responses, 14-byte/500,000-request, 153,600-byte/200,000-request, and 3,145,728-byte/20,000-request pairs at 1, 10, 50, 100, and 400 VU. Niswar and Hamo use fixed-iteration execution; Jarmoszewicz uses 60-second load execution. Every run performs 10 read-only warm-up requests before sampling and measurement.
